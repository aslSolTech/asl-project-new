          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Registration Charges" : "Edit Registration Charges"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new registration charges." : "Update details for the selected registration charges."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
