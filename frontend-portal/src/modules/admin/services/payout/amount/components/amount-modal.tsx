          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Amount Wise Routing" : "Edit Amount Wise Routing"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new amount wise routing." : "Update details for the selected amount wise routing."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
