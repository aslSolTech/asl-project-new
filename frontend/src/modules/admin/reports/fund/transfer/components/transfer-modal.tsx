          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Fund Transfer Report" : "Edit Fund Transfer Report"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new fund transfer report." : "Update details for the selected fund transfer report."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
