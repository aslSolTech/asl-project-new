          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Package Report" : "Edit Package Report"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new package report." : "Update details for the selected package report."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
