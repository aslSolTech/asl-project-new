...
import { useDeleteDmtDashboardMutation } from "../hooks";
import { AlertTriangle, Trash2 } from "lucide-react";

export function DmtDashboardDeleteDialog() {
  const { isDeleteOpen, deletingId, deletingName, closeDelete } = useDmtDashboardModalStore();
  const deleteMutation = useDeleteDmtDashboardMutation();
