...
export function ContactDeleteDialog() {
  const { isDeleteOpen, deletingId, deletingName, closeDelete } = useContactModalStore();
    ...
    <Dialog open={isDeleteOpen} onOpenChange={(open) => !open && closeDelete()}>
      <DialogContent className="max-w-md">
        <DialogHeader className="flex flex-col items-center gap-2">
          ...
          <DialogTitle className="text-lg font-bold">Delete Contact Support Info</DialogTitle>
