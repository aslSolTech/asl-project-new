          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Announcements" : "Edit Announcements"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new announcements." : "Update details for the selected announcements."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
