          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New User Register" : "Edit User Register"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new user register." : "Update details for the selected user register."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
