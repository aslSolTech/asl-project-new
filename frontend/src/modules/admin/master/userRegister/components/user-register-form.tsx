...
import { userRegisterFieldsConfig } from "../constants";
    ...
    <form.AppForm>
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          {userRegisterFieldsConfig.map((field) => (
            <div key={field.key}>
              <form.AppField
                name={field.key}
                validators={{
                  onChange: ({ value }) => {
                    const shape = userRegisterSchema.shape[field.key as keyof typeof userRegisterSchema.shape];
