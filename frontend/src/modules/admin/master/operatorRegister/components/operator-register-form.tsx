...
import { operatorRegisterFieldsConfig } from "../constants";
    ...
    <form.AppForm>
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          {operatorRegisterFieldsConfig.map((field) => (
            <div key={field.key}>
              <form.AppField
                name={field.key}
                validators={{
                  onChange: ({ value }) => {
                    const shape = operatorRegisterSchema.shape[field.key as keyof typeof operatorRegisterSchema.shape];
