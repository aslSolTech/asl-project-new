          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Service Categories" : "Edit Service Categories"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new service categories." : "Update details for the selected service categories."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
