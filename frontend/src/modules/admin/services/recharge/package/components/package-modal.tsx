          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Package Wise API" : "Edit Package Wise API"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new package wise api." : "Update details for the selected package wise api."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
