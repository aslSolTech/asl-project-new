...
import { useUserListQuery } from "@/modules/admin/routing/payout/user/hooks";
import { useUserModalStore } from "@/modules/admin/routing/payout/user/stores/useUserModalStore";
import { UserRecord } from "@/modules/admin/routing/payout/user/types";
import { UserModal } from "@/modules/admin/routing/payout/user/components/user-modal";
import { UserDeleteDialog } from "@/modules/admin/routing/payout/user/components/user-delete-dialog";
import {
  Route,
  Plus,
  Edit2,
