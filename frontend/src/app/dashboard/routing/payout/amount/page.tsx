...
import { useAmountListQuery } from "@/modules/admin/routing/payout/amount/hooks";
import { useAmountModalStore } from "@/modules/admin/routing/payout/amount/stores/useAmountModalStore";
import { AmountRecord } from "@/modules/admin/routing/payout/amount/types";
import { AmountModal } from "@/modules/admin/routing/payout/amount/components/amount-modal";
import { AmountDeleteDialog } from "@/modules/admin/routing/payout/amount/components/amount-delete-dialog";
import {
  Route,
  Plus,
  Edit2,
