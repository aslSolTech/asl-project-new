...
import { useAmountListQuery } from "@/modules/admin/routing/recharge/amount/hooks";
import { useAmountModalStore } from "@/modules/admin/routing/recharge/amount/stores/useAmountModalStore";
import { AmountRecord } from "@/modules/admin/routing/recharge/amount/types";
import { AmountModal } from "@/modules/admin/routing/recharge/amount/components/amount-modal";
import { AmountDeleteDialog } from "@/modules/admin/routing/recharge/amount/components/amount-delete-dialog";
import {
  Route,
  Plus,
  Edit2,
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
              Amount Wise API Setup
            </h1>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Manage all official amount wise api configurations.
            </p>
          </div>
        </div>
