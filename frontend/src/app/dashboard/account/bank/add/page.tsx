...
import { useAddListQuery } from "@/modules/admin/account/bank/add/hooks";
import { useAddModalStore } from "@/modules/admin/account/bank/add/stores/useAddModalStore";
import { AddRecord } from "@/modules/admin/account/bank/add/types";
import { AddModal } from "@/modules/admin/account/bank/add/components/add-modal";
import { AddDeleteDialog } from "@/modules/admin/account/bank/add/components/add-delete-dialog";
import {
  Wallet,
  Plus,
  Edit2,
