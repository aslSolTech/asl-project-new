...
function PopoverTitle({ className, ...props }: Readonly<React.ComponentProps<typeof PopoverPrimitive.Title>>) {
  return (
...
function PopoverDescription({
  className,
  ...props
}: Readonly<React.ComponentProps<typeof PopoverPrimitive.Description>>) {
  return (
