...
export const companySetupSchema = z.object({
  ...
  companyLogo: z.custom<File | null | undefined>((val) => val === undefined || val === null || typeof window === "undefined" || val instanceof File, "Invalid file format").optional(),
  ...
  website: z.url("Please enter a valid URL (e.g. https://example.com)").optional().or(z.literal("")),
