...
import { navItems } from '@/constants/landingpage/header';
...
export default function Header() {
  ...
  return (
    <div className="relative mx-4 bg-transparent">
      <Navbar>
        {/* Desktop Navigation */}
        <NavBody>
          ...
          <div className="flex items-center gap-4">
            ...
            <NavbarButton onClick={() => router.push("/signup")} variant="gradient">Download App</NavbarButton>
          </div>
        </NavBody>
