...
import { API_TYPE_API_ENDPOINTS } from "./endpoints";
import { ApiTypeRecord, CreateApiTypePayload, UpdateApiTypePayload } from "./types";

export const apiTypeKeys = {
  all: ["api-type"] as const,
...
export function useApiTypeDetailQuery(id?: string) {
  return useApiQuery<ApiTypeRecord>(
    ...
    API_TYPE_API_ENDPOINTS.DETAIL(id!),
...
export function useUpdateApiTypeMutation() {
  ...
  return useApiMutation<ApiTypeRecord, Error, UpdateApiTypePayload>(
    (variables) => API_TYPE_API_ENDPOINTS.UPDATE(variables.id),
    {
      method: "PUT",
      options: {
        onSuccess: () => {
...
export function useDeleteApiTypeMutation() {
  ...
  return useApiMutation<{ success: boolean; message?: string }, Error, string>(
    (id) => API_TYPE_API_ENDPOINTS.DELETE(id),
    {
      method: "DELETE",
      options: {
        onSuccess: () => {
