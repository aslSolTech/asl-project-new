...
import { useDeletePrivilegeMutation } from "../hooks";
import { AlertTriangle, Trash2 } from "lucide-react";

export function PrivilegeDeleteDialog() {
  const { isDeleteOpen, deletingId, deletingName, closeDelete } = usePrivilegeModalStore();
