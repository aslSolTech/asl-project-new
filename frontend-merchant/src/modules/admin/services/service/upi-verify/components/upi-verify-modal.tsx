...
import {
  useUpiVerifyDetailQuery,
  useCreateUpiVerifyMutation,
      ...
      <DialogContent className="max-w-xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription className="text-xs">
                {mode === "create"
                  ? "Enter details to create a new upi verify api."
                  : "Update details for the selected upi verify api."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        {isLoading ? (
          ...
          <ServiceApiSharedForm
            ...
            providerPlaceholder="Enter Provider name (e.g. Decentro, Setu, Cashfree)..."
            isPending={isPending}
            onSubmit={async (data) => {
              if (mode === "create") {
