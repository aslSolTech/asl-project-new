          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold">
                {mode === "create" ? "Add New Recharge Report" : "Edit Recharge Report"}
              </DialogTitle>
              <DialogDescription className="text-xs">
                {mode === "create" ? "Enter details to create a new recharge report." : "Update details for the selected recharge report."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
