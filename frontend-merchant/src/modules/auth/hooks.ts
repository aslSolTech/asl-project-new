...
export function useResetPasswordMutation() {
  ...
  return useApiMutation<AuthResponse, Error, import("./types").ResetPasswordRequest>(
    AUTH_API_ENDPOINTS.RESET_PASSWORD,
    {
      ...
      options: {
        ...
        onSuccess: (data) => {
          setAuthSuccess(null, null, data.message ?? "Password reset successfully! Please login with your new password.");
        },
        onError: (error: Error) => {
          setAuthError(error.message);
        },
