...
export default function StatsSection() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-24 border-y border-border bg-muted/20">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group p-6 rounded-2xl border border-border bg-card shadow-xs hover:border-primary/60 hover:shadow-xl hover:shadow-primary/5 transition-all flex flex-col justify-between relative overflow-hidden cursor-pointer"
              >
